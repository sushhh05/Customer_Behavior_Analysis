...
-- > we used sum(case when discount_applied = 'Yes' then 1 else 0 end) this case for count the total orders we use case
--   because the sum function doesnt work on yes and no it works only on int.
select item_purchased, 
...
-- Q7. Segment customers into new, returning, and loyal based o their total no. of previous purchases and show the count of each segment.
-- here we use CTE common table expression means we made a temp table name customer_type
...
case when previous_purchases = 1 then 'New'
     ...
     as customer_segment from customer ) 
